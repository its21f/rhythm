...
window.boot = function() {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? '../../games/daxigua/src/project.dev.js' : '../../games/daxigua/src/project.js';
        if (jsList) {
    ...
    cc.AssetLibrary.init({
        libraryPath: '../../games/daxigua/res/import',
        rawAssetsBase: '../../games/daxigua/res/raw-',
