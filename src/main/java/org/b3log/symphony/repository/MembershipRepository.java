...
@Repository
public class MembershipRepository extends AbstractRepository {

    public MembershipRepository() {
        super(Membership.MEMBERSHIP);
    }

    public JSONObject getByUserIdAndLvCode(final String userId, final String lvCode) throws RepositoryException {
    ...
    public JSONObject getActiveByUserId(final String userId) throws RepositoryException {
        final Query query = new Query().setFilter(
                org.b3log.latke.repository.CompositeFilterOperator.and(
                        new PropertyFilter(Membership.USER_ID, FilterOperator.EQUAL, userId),
